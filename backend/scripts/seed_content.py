...
SEED_ITEMS = [
    ...
    # ── YouTube ──────────────────────────────────────────────────────────────
    {
        ...
        "description": (
            "A beginner-friendly video covering the 100 most common "
            "Spanish words with pronunciation and example sentences."
        ),
    ...
    },
    {
        ...
        "description": (
            "Natural conversation between two native speakers discussing "
            "everyday topics. Subtitles included."
        ),
    ...
    },
    {
        ...
        "thumbnail_url": None,
        "description": (
            "A panel debate on contemporary political and social issues "
            "in Latin America. Suitable for advanced learners."
        ),
    ...
    },
    {
        ...
        "description": (
            "Learn all 46 hiragana characters with stroke order, "
    ...
    {
        "title": "Português para Iniciantes — Basic phrases for travel",
        "url": "https://www.youtube.com/watch?v=8fT78dnLQqM",
        "source_type": SourceType.YOUTUBE,
        "language": "pt",
        "cefr_level": CEFRLevel.A2,
        "thumbnail_url": "https://img.youtube.com/vi/8fT78dnLQqM/maxresdefault.jpg",
        "description": (
            "Essential Brazilian Portuguese phrases for travelers, with "
            "on-screen text and slow, clear pronunciation."
        ),
        "duration_seconds": 900,
        "published_at": datetime(2023, 12, 4, tzinfo=UTC),
    },
    # ── Music ────────────────────────────────────────────────────────────────
    {
